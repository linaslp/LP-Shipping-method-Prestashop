...
class LpShippingConsts
{
    ...
    const SMALL_CORRESPONDENCE = 'SmallCorrespondence';
    const MEDIUM_CORRESPONDENCE = 'MediumCorrespondence';
    const PARCEL = 'Parcel';

    const SMALL_CORRESPONDENCE_SIZE_NAME = 'Small';
    const MEDIUM_CORRESPONDENCE_SIZE_NAME = 'Medium';

    const SMALL_CORRESPONDENCE_OLD = 'SMALL_CORESPONDENCE';
    const SMALL_CORESPONDENCE_TRACKED_OLD = 'SMALL_CORESPONDENCE_TRACKED';
    const MEDIUM_CORRESPONDENCE_OLD = 'BIG_CORESPONDENCE';
    const MEDIUM_CORRESPONDENCE_TRACKED_OLD = 'MEDIUM_CORESPONDENCE_TRACKED';
    const PARCEL_OLD = 'PACKAGE';

    const LP_SHIPPING_BULK_INIT_CHUNK_SIZE = 50;
    const LP_SHIPPING_LABEL_PRINT_CHUNK_SIZE = 50;

    const STATUS_PENDING = 'PENDING';
    const STATUS_NOT_FOUND = 'STATE_NOT_FOUND';
}
